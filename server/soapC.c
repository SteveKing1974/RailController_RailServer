...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.27 2016-01-23 11:44:31 GMT")
...
SOAP_FMAC3 struct f__form2 * SOAP_FMAC4 soap_in_f__form2(struct soap *soap, const char *tag, struct f__form2 *a, const char *type)
{
	...
	{	a = (struct f__form2 *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_f__form2, SOAP_TYPE_f__form2, sizeof(struct f__form2), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct f__formResponse * SOAP_FMAC4 soap_in_f__formResponse(struct soap *soap, const char *tag, struct f__formResponse *a, const char *type)
{
	...
	{	a = (struct f__formResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_f__formResponse, SOAP_TYPE_f__formResponse, sizeof(struct f__formResponse), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 struct f__form1 * SOAP_FMAC4 soap_in_f__form1(struct soap *soap, const char *tag, struct f__form1 *a, const char *type)
{
	...
	{	a = (struct f__form1 *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_f__form1, SOAP_TYPE_f__form1, sizeof(struct f__form1), 0, NULL, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
